...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "education.txt": "I have a Masters degree in Systems and Application Security from IIT Kanpur, India. \nI studied Bachelors of Technology in Computer Science in the Charotar University, India, where I graduated.",
        "experience.txt": "I started my career journey as an Information Security Engineer for Walmart-Labs, where I mostly worked on Web application annd mobile application security by doing code reviews and penetration testing as a full time job for two years. \n\nI then worked as a Product Security Engineer at VMWare, where I was responsible for security of the VMWare products like vCenter, ESXi, VMWare Workstation and VMWare Fusion. \n\nAfter completing two years at VMware, I joined and currently working as a Security Architect for Goldman Sachs, where I was responsible to do Security Design Reviews, Security Architecture Reviews, Threat Modelling on internal Goldman Sachs applications and services. \n\nI joined Halborn as a Blockchain Security Engineer in Oct, 2020 where I was working on audit of Ethereum Smart Contracts, Solana Smart Contracts,  many web3 application frontend audit and wallet audit majorly. Here are some of the work experience in smart contract audit I have done:\n\t- CentaurSwap: https://github.com/HalbornSecurity/PublicReports/blob/master/CentaurSwap_Smart_Contract_Security_Audit_Halborn_v1_1.pdf\n\t\thttps://github.com/HalbornSecurity/PublicReports/blob/master/Financial%20Pentesting/CentaurSwap_Financial_Pentesting_Halborn_v1_1.pdf\n\t- BSCEX: https://github.com/HalbornSecurity/PublicReports/blob/master/Solidity%20Smart%20Contract%20Audits/BSCEX_Launchpoolx_SmartContract_Report_Halborn_v1.pdf\n\t- Jarvis: https://github.com/HalbornSecurity/PublicReports/blob/master/Solidity%20Smart%20Contract%20Audits/Jarvis_perpetualpoolparty_Halborn_audit.pdf\n\t- PartyParrot: https://github.com/HalbornSecurity/PublicReports/blob/master/Solana%20Program%20Audit/Party_Parrot_Solana_Smart_Contract_Security_Audit_Report_Halborn_v1_1.pdf\n\t- Reef Finance: https://github.com/HalbornSecurity/PublicReports/blob/master/Solidity%20Smart%20Contract%20Audits/Reef_Finance_SmartContract_Halborn_Report_V1_1.pdf",
        "certs.txt": "The following list contains all of the certificates I obtained:\n\t- Offensive Security Certified Professional (OSCP)",
        "contact.txt": "nishit.nm@gmail.com",
        "twitter.txt": "https://twitter.com/nishit_nm/",
        "linkedin.txt": "https://www.linkedin.com/in/nishit.majithia/"
